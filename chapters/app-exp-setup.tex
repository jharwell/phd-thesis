...
\begin{figure}[!htbp]
  ...
  \phdcaption{Task decomposition graph for the foraging task}{The set of red and
    ...
    defined~\cite{Harwell2019a}.\label{fig:tdgraph-foraging}}
\end{figure}
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}{0.49\linewidth}
    ...
    \phdcaption{\emph{Single source} (SS) object distribution, with objects on the right and the nest
      on the left}{\label{fig:fbd-ss}}
  \end{subfigure}
  %
  \begin{subfigure}{0.49\linewidth}
    \includegraphics[]{figures/ds-foraging.png}
    \phdcaption{\emph{Dual source} (DS) object distribution, with
      objects on the right and left and the nest in the center}{\label{fig:fbd-ds}}
  \end{subfigure}
  %
  \begin{subfigure}{0.24\linewidth}
    {\includegraphics[width=.99\linewidth]{figures/pl-foraging.png}}
    \phdcaption{\emph{Power law } (PL) object distribution, with the nest in the center}{\label{fig:fbd-pl}}
  \end{subfigure}
  %
  \begin{subfigure}{0.24\linewidth}
    {\includegraphics[width=.99\linewidth]{figures/rn-foraging.png}}
    \phdcaption{\emph{Random} (RN) object distribution, with the nest in the center}{\label{fig:fbd-rn}}
  \end{subfigure}
  %
